...
public class FramedCapitalQuarterVertical extends CustomFramedBlock {
    /**
     * Layers count.
     */
     ...
     * Constructor.
     */
    public FramedCapitalQuarterVertical() {
        super(new CustomBlockType.Builder(FramedCapitalQuarterVertical::getShapeForState)
    ...
    public BlockItem createBlockItem() {
        return new FramedSpecialBlockItem.Single(this, new Item.Properties()) {
            protected @Nullable BlockState getReplacementState(BlockPlaceContext ctx, BlockState originalState) {
                return FramedCapitalQuarterVertical.this.getStateForPlacement(ctx);
            }
        };
    }
