...
public class FramedCornerVertical extends CustomFramedBlock {
    public static final VoxelShape[] VERTICAL_SLAB_EAST_SHAPE = new VoxelShape[]{Block.box(0.0F, 0.0F, 0.0F, 2.0F, 16.0F, 16.0F), Block.box(0.0F, 0.0F, 0.0F, 4.0F, 16.0F, 16.0F), Block.box(0.0F, 0.0F, 0.0F, 8.0F, 16.0F, 16.0F), Block.box(0.0F, 0.0F, 0.0F, 12.0F, 16.0F, 16.0F)};
    public static final VoxelShape[] VERTICAL_SLAB_WEST_SHAPE = new VoxelShape[]{Block.box(14.0F, 0.0F, 0.0F, 16.0F, 16.0F, 16.0F), Block.box(12.0F, 0.0F, 0.0F, 16.0F, 16.0F, 16.0F), Block.box(8.0F, 0.0F, 0.0F, 16.0F, 16.0F, 16.0F), Block.box(4.0F, 0.0F, 0.0F, 16.0F, 16.0F, 16.0F)};
    public static final VoxelShape[] VERTICAL_SLAB_SOUTH_SHAPE = new VoxelShape[]{Block.box(0.0F, 0.0F, 0.0F, 16.0F, 16.0F, 2.0F), Block.box(0.0F, 0.0F, 0.0F, 16.0F, 16.0F, 4.0F), Block.box(0.0F, 0.0F, 0.0F, 16.0F, 16.0F, 8.0F), Block.box(0.0F, 0.0F, 0.0F, 16.0F, 16.0F, 12.0F)};
    public static final VoxelShape[] VERTICAL_SLAB_NORTH_SHAPE = new VoxelShape[]{Block.box(0.0F, 0.0F, 14.0F, 16.0F, 16.0F, 16.0F), Block.box(0.0F, 0.0F, 12.0F, 16.0F, 16.0F, 16.0F), Block.box(0.0F, 0.0F, 8.0F, 16.0F, 16.0F, 16.0F), Block.box(0.0F, 0.0F, 4.0F, 16.0F, 16.0F, 16.0F)};
    public static final VoxelShape[] EAST_SHAPE = new VoxelShape[]{Shapes.or(VERTICAL_SLAB_EAST_SHAPE[0], VERTICAL_SLAB_NORTH_SHAPE[0]), Shapes.or(VERTICAL_SLAB_EAST_SHAPE[1], VERTICAL_SLAB_NORTH_SHAPE[1]), Shapes.or(VERTICAL_SLAB_EAST_SHAPE[2], VERTICAL_SLAB_NORTH_SHAPE[2]), Shapes.or(VERTICAL_SLAB_EAST_SHAPE[3], VERTICAL_SLAB_NORTH_SHAPE[3])};
    public static final VoxelShape[] WEST_SHAPE = new VoxelShape[]{Shapes.or(VERTICAL_SLAB_WEST_SHAPE[0], VERTICAL_SLAB_SOUTH_SHAPE[0]), Shapes.or(VERTICAL_SLAB_WEST_SHAPE[1], VERTICAL_SLAB_SOUTH_SHAPE[1]), Shapes.or(VERTICAL_SLAB_WEST_SHAPE[2], VERTICAL_SLAB_SOUTH_SHAPE[2]), Shapes.or(VERTICAL_SLAB_WEST_SHAPE[3], VERTICAL_SLAB_SOUTH_SHAPE[3])};
    public static final VoxelShape[] NORTH_SHAPE = new VoxelShape[]{Shapes.or(VERTICAL_SLAB_NORTH_SHAPE[0], VERTICAL_SLAB_WEST_SHAPE[0]), Shapes.or(VERTICAL_SLAB_NORTH_SHAPE[1], VERTICAL_SLAB_WEST_SHAPE[1]), Shapes.or(VERTICAL_SLAB_NORTH_SHAPE[2], VERTICAL_SLAB_WEST_SHAPE[2]), Shapes.or(VERTICAL_SLAB_NORTH_SHAPE[3], VERTICAL_SLAB_WEST_SHAPE[3])};
    public static final VoxelShape[] SOUTH_SHAPE = new VoxelShape[]{Shapes.or(VERTICAL_SLAB_SOUTH_SHAPE[0], VERTICAL_SLAB_EAST_SHAPE[0]), Shapes.or(VERTICAL_SLAB_SOUTH_SHAPE[1], VERTICAL_SLAB_EAST_SHAPE[1]), Shapes.or(VERTICAL_SLAB_SOUTH_SHAPE[2], VERTICAL_SLAB_EAST_SHAPE[2]), Shapes.or(VERTICAL_SLAB_SOUTH_SHAPE[3], VERTICAL_SLAB_EAST_SHAPE[3])};
