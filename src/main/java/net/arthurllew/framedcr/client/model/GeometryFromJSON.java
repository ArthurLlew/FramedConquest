...
public class GeometryFromJSON extends Geometry {
    /**
     * Original JSON model.
     */
     ...
     * Constructor.
     */
    public GeometryFromJSON(GeometryFactory.Context ctx) {
    ...
    /**
     * For each quad in a list apply remapping, copy tint index (color info)
    ...
    /**
     * Forces API to call {@link GeometryFromJSON ::transformQuad} for all camo model faces regardless of
